  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="py-20 bg-background">
        <motion.div {...fadeUp(0)} className="container mx-auto px-4 md:px-6 max-w-2xl text-center">
          <div className="rounded-3xl p-10 md:p-14"
            ...
            <a href="mailto:themilestoneKtl@gmail.com"
              ...
              style={{ background:"linear-gradient(135deg,#10B981,#059669)", color:"white", boxShadow:"0 8px 28px rgba(16,185,129,0.4)" }}>
              {isHindi ? "संपर्क करें" : "Get in Touch"} <Handshake size={16}/>
            </a>
          </div>
        </motion.div>
      </section>
