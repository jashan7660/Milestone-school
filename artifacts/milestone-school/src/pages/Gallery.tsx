...
export default function GalleryPage() {
  const images = [
    { src: img1, alt: "Students with school principal in office" },
    { src: img2, alt: "Group photo at The Tribune visit" },
    { src: img3, alt: "Cultural celebration at The Milestone" },
    { src: img4, alt: "Student music performance on stage" },
    { src: img5, alt: "Class group photograph in auditorium" },
    { src: img6, alt: "Annual day stage performance" },
    { src: img7, alt: "School assembly with students and staff" },
    { src: img8, alt: "Award winners with certificates" },
    { src: img9, alt: "Investiture ceremony at school entrance" },
  ];
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-foreground mb-5 leading-tight">
                Celebrations, Achievements & Campus Life
              </h2>
            ...
            <div className="mt-16 text-center">
              <Link href="/">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full px-8 h-12 border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all"
                >
