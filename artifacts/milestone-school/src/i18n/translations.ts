...
export const UI: Record<Lang, Record<string, string>> = {
  en: {
    ...
    millieTour:     "MILESTONE MENTOR — Website Tour",
    millieChat:     "MILESTONE MENTOR",
    aiSubtitle:     "MILESTONE MENTOR · MILESTONE SCHOOL",
    aiSubtitleTour: "MILESTONE MENTOR · MILESTONE SCHOOL",
    defaultReply:   "🤔 Great question! For more details:\n📞 Call: +91 98125-74766\n✉️ Email: themilestoneKtl@gmail.com\n\nOr start the guided tour to explore our website!",
    welcomeMsg:     "👋 Namaste! I'm Milestone Mentor, your AI Guide!\n\nAsk me anything about The Milestone Sr. Sec. School — admissions, timings, facilities, academics, and more.",
  },
  hi: {
